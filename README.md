...
The experimental data provide the data for the variable-condition G6 operation mode.Due to the large size of the data package, it has been saved on Baidu Netdisk. The following is the Baidu Netdisk link.
# https://pan.baidu.com/s/1XF9TN_CtJz2moLW3ZPwnPg?pwd=6666 code: 6666 
#
#
